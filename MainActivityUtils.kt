...
fun isUrlAllowed(url: Uri): Boolean {
    ...
    val allowedBeginnings = listOf("student.vscht.cz")
    val disallowedBeginnings = listOf("student.vscht.cz/v4")
...
/*
    Returns List of page identifiers for SIS pages (starting with "student.vscht.cz").
    Path sections and "do" and "doe" parameters are considered.
    Examples:
        https://student.vscht.cz/index.php?id=...&tid=& -> [index]
        https://student.vscht.cz/predm_st2/index.php?id=...&tid=&KEY=... -> [predm_st2]
        https://student.vscht.cz/predmety/index.php?id=...&tid=&do=prohl -> [predmety prohl]
        https://student.vscht.cz/omne/index.php?id=...&tid=&do=email&doe=email_detail&mail_id=...&arch=0 -> [omne email email_detail]
 */
